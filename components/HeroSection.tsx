      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center gap-10 lg:gap-16">
        ...
        <div className="w-full md:w-[55%] lg:flex-1 flex flex-col items-start lg:pt-10">
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-[56px] lg:text-[72px] xl:text-[88px] md:leading-[1.1] lg:leading-[1.05] font-extrabold tracking-tight text-gray-900 mb-6"
          >
          ...
          <motion.p
            ...
            className="text-lg text-gray-600 leading-relaxed max-w-lg mb-[72px]"
          >
          ...
          <motion.div
            ...
            className="flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-gray-500 dark:text-gray-400 mt-[40px]"
          >
            {trustItems.map((t) => (
